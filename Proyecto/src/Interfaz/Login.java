...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelUsr.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        ...
        labelPass.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
    ...
    private void olvidarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_olvidarMouseClicked
        Recuperacion1 rec = new Recuperacion1();
        rec.setVisible(true);
        this.dispose();
